        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                ...
                case 2:
                    ...
                    GUILayout.EndHorizontal();
                    // GUILayout.BeginHorizontal(EditorStyles.helpBox);
                    // EditorGUILayout.LabelField(new GUIContent("Start Point"), customSkin.FindStyle("Text"), GUILayout.Width(120));
                    // EditorGUILayout.PropertyField(startPoint, new GUIContent(""));
                    // GUILayout.EndHorizontal();
                    GUILayout.BeginHorizontal(EditorStyles.helpBox);
